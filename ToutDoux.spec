...
ToutDoux jest programem do zarządzania projektami pozwalającym na
uwzględnianie różnych punktów widzenia (bazując na pluginach). Można
za jego pomocą np. projektować plan zadań używając struktury
drzewiastej.
...
Pliki nagłówkowe itp. do ToutDoux.
