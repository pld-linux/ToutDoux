...
uwzglÍdnianie rÛønych punktÛw widzenia (bazuj±c na pluginach). Moøesz
np. projektowaÊ plan zadaÒ uøywaj±c struktury drzewiastej.

%package devel
Summary:	%{name} libraries, includes, etc
Summary(pl):	%{name} - pliki nag≥Ûwkowe, etc
